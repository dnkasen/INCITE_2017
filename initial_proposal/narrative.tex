...
previous INCITE awards.  \MarginPar{Bronson: add a paragraph on accomplishments with DD time below}

\paragraph{\maestro\ sub-Ch convection models.}
%
We completed an exhaustive study of convection in the He layer
on \MarginPar{Adam update} sub-Ch WD, exploring a range of initial
...
merger \MarginPar{Max: update} of two WDs~\cite{katz:2016} (see
